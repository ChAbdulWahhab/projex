#!/bin/bash
# Git Commits for Release 4.0.0
# Run these commands in sequence

# Commit 1: Phase 1 - Framework templates
git add projex/generator.py projex/config.py projex/cli.py
git commit -m "feat: add 5 new framework templates (Bottle, Pyramid, Tornado, Sanic, CherryPy)
...
# Commit 2: Phase 1 - Database support
git add projex/generator.py projex/cli.py
git commit -m "feat: add multiple database support (PostgreSQL, MySQL, MongoDB, SQLite, Redis)
...
# Commit 3: Phase 1 - Template styles
git add projex/generator.py projex/cli.py
git commit -m "feat: add template style variations (minimal, standard, full)
...
# Commit 4: Phase 2 - Smart scaffolding
git add projex/commands/add.py projex/utils/codegen.py projex/utils/detector.py projex/cli.py
git commit -m "feat: add smart scaffolding system for code generation
...
# Commit 5: Phase 2 - Authentication
git add projex/generator.py projex/cli.py
git commit -m "feat: add multiple authentication methods (JWT, OAuth2, API Key, Basic)
...
# Commit 6: Phase 2 - Quality tools
git add projex/commands/add.py projex/utils/quality_tools.py
git commit -m "feat: add pre-commit hooks and code quality tools
...
# Commit 7: Phase 2 - Validation and Info
git add projex/commands/validate.py projex/cli.py
git commit -m "feat: add project validation and info commands
...
# Commit 8: Phase 3 - CI/CD
git add projex/commands/add.py projex/utils/cicd.py
git commit -m "feat: add CI/CD pipeline generator (GitHub Actions, GitLab CI, CircleCI)
...
# Commit 9: Phase 3 - Environment management
git add projex/commands/env.py projex/utils/env_utils.py projex/cli.py
git commit -m "feat: add environment configuration generator
...
# Commit 10: Phase 3 - Makefile
git add projex/commands/add.py projex/utils/makefile_utils.py
git commit -m "feat: add Makefile generator with common development tasks
...
# Commit 11: Phase 4 - Dependency management
git add projex/commands/deps.py projex/utils/deps_utils.py projex/cli.py
git commit -m "feat: add dependency management commands
...
# Commit 12: Phase 4 - Documentation
git add projex/commands/add.py projex/utils/docs_utils.py
git commit -m "feat: add documentation setup (MkDocs and Sphinx)
...
# Commit 13: Phase 4 - Testing enhancements
git add projex/commands/add.py projex/utils/test_utils.py
git commit -m "feat: add enhanced testing configuration
...
# Commit 14: Phase 4 - License and gitignore
...
git commit -m "docs: update documentation for Release 4.0.0
...
# Commit 16: CHANGELOG update
git add CHANGELOG.md
git commit -m "docs: update CHANGELOG.md for Release 4.0.0
...
# Commit 17: Version bump and dependencies
git add projex/__init__.py projex/cli.py setup.py requirements.txt projex/utils/quality_tools.py
git commit -m "chore: bump version to 4.0.0 and update dependencies
...
# Commit 18: Final preparation
git add .gitignore
git commit -m "chore: final Release 4.0.0 preparation
